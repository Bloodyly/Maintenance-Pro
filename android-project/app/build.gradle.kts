...
// Release signing material lives outside version control (see .gitignore) --
// this file only exists on machines that actually cut a release. Its absence
// intentionally makes assembleRelease/bundleRelease fail loudly rather than
// silently falling back to an unsigned or debug-signed build.
